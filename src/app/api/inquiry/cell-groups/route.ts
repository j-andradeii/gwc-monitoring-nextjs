import { joinSchema } from '@/models/schemas/contact.schema';
...
export async function POST(request: Request) {
    try {
        ...
        return NextResponse.json({
            ...result,
            message: 'Cell group inquiry received.',
        });
    } catch (error) {
        console.error('Cell group inquiry submission error:', error);
        return NextResponse.json(
